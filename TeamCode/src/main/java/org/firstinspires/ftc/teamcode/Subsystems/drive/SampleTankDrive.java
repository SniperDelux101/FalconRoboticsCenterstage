...
public class SampleTankDrive extends TankDrive {
    ...
    public SampleTankDrive(HardwareMap hardwareMap) {
        ...
        DcMotorEx leftFront = hardwareMap.get(DcMotorEx.class, "Left_Front_Wheel");
        DcMotorEx leftRear = hardwareMap.get(DcMotorEx.class, "Left_Rear_Wheel");
        DcMotorEx rightRear = hardwareMap.get(DcMotorEx.class, "Right_Rear_Wheel");
        DcMotorEx rightFront = hardwareMap.get(DcMotorEx.class, "Right_Front_Wheel");
