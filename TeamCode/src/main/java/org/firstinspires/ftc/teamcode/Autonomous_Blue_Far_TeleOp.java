...
public class Autonomous_Blue_Far_TeleOp extends OpMode {
    private Callisto robot;

    public Autonomous_Blue_Far_TeleOp() {

    }
    @Override
    public void init() {
        telemetry = new MultipleTelemetry(telemetry, FtcDashboard.getInstance().getTelemetry());
        robot = new Callisto(RobotMode.AUTO, hardwareMap, gamepad1, gamepad2, telemetry, Alliance.Blue, AutonomousStartLocation.Far);
    }
