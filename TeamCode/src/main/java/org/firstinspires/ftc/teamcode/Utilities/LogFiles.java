...
public final class LogFiles {
    ...
    public static class LogFile {
        ...
        public double ticksPerRev = Configuration.TICKS_PER_REV;
        public double maxRpm = Configuration.MAX_RPM;
        public boolean runUsingEncoder = Configuration.RUN_USING_ENCODER;
        public double motorP = Configuration.MOTOR_VELO_PID.p;
        public double motorI = Configuration.MOTOR_VELO_PID.i;
        public double motorD = Configuration.MOTOR_VELO_PID.d;
        public double motorF = Configuration.MOTOR_VELO_PID.f;
        public double wheelRadius = Configuration.WHEEL_RADIUS;
        public double gearRatio = Configuration.GEAR_RATIO;
        public double trackWidth = Configuration.TRACKWIDTH;
        public double kV = Configuration.kV;
        public double kA = Configuration.kA;
        public double kStatic = Configuration.kStatic;
        public double maxVel = Configuration.MAX_VEL;
        public double maxAccel = Configuration.MAX_ACCEL;
        public double maxAngVel = Configuration.MAX_ANG_VEL;
        public double maxAngAccel = Configuration.MAX_ANG_ACCEL;

        public double mecTransP = FalconMecanumDrive.TRANSLATIONAL_PID.kP;
        public double mecTransI = FalconMecanumDrive.TRANSLATIONAL_PID.kI;
        public double mecTransD = FalconMecanumDrive.TRANSLATIONAL_PID.kD;
